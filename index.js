...
Kon = await getBuffer(`https://hardianto.xyz/api/welcome3?profile=${encodeURIComponent(ppuser)}&name=${encodeURIComponent(nama)}&bg=https://telegra.ph/file/2b3e5bb20594499999888.jpg&namegb=${encodeURIComponent('OUR GROUP')}&member=${encodeURIComponent(memb)}`)
